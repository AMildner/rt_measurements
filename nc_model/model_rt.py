...
if __name__ == '__main__':
    ...
    #plt.grid(True)
    #plt.show()
    plt.savefig("paper_graph1_final.pdf", bbox_inches="tight")
    plt.close()
    ...
    plt.grid(False)
    #plt.show()
    plt.savefig("paper_graph2_final.pdf", bbox_inches="tight")
    plt.close()
    ...
    plt.grid(False)
    #plt.show()
    plt.savefig("paper_graph3_final.pdf", bbox_inches="tight")
    plt.close()
    '''
